...
const filteredDocumentsByProject = computed(() => {
  return sortedDocumentsByProject.value[filter.projectName] || [];
});
            ...
            <rs-card class="h-full">
                ...
                <template #body>
                    ...
                    <rs-card class="p-4 h-full" style="max-height: 55vh; overflow-y: auto;">
                        <div v-for="(docs, projectName) in { [filter.projectName]: filteredDocumentsByProject }" :key="projectName">
