        ...
        <rs-table :data="tableData" advanced>           
          <template v-slot:tindakan="data">
              <div class="flex gap-2">  
                ...
                <NuxtLink :to="`/ivv/tetapan/jenis_dokumen/${data.value.id}`" >  
                    <rs-button variant="primary" title="Muat Naik Dokumen" class="gap-1">
                        <Icon name="material-symbols:edit" class="w-4 h-4 gap-2" > </Icon>
                        Kriteria Minimum
                    </rs-button>                                    
                </NuxtLink>
